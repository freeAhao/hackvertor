...
public class Hackvertor {
    ...
    public void init() {
        ...
        tag.argument2 = new TagArgument("int", "24");
        tag.argument3 = new TagArgument("string", "AES/ECB/PKCS5PADDING");
        tag.argument4 = new TagArgument("string", "initVector123456");
        tags.add(tag);
    ...
    public void loadCustomTags() {
        ...
        if (json != null && json.length() > 0) {
            try {
                this.setCustomTags(new JSONArray(json));
    ...
    public void saveCustomTags() {
        BurpExtender.callbacks.saveExtensionSetting("customTags", this.getCustomTags().toString());
    }
    ...
    public void updateCustomTag(String tagName, String language, String code, String argument1, String argument1Type, String argument1DefaultValue, String argument2, String argument2Type, String argument2DefaultValue, int numberOfArgs) {
        ...
        tag.put("code", code);
        for (int i = 0; i < this.getCustomTags().length(); i++) {
            JSONObject customTag = (JSONObject) this.getCustomTags().get(i);
            if (tagName.equals(customTag.getString("tagName"))) {
                this.getCustomTags().put(i, tag);
                saveCustomTags();
                break;
            }
        }
